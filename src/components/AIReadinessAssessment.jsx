...
const animatedBorderStyles = `
  ...
  .ai-questions { display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; }
  .ai-assessment-grid { display: grid; grid-template-columns: 1fr 2fr; gap: 24; align-items: start; }
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className="ai-assessment-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 24, alignItems: 'start' }}>
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexDirection: 'column' }}>
                <div className="gauge" aria-hidden>
                  ...
                  <div className="value" style={{ fontSize: 28 }}>{score}</div>
                </div>
            ...
            <div>
              ...
              <div style={{ color: '#CBD5E1', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: 16 }}>
